...
def get_parser():
    ...
    parser = argparse.ArgumentParser(
        ...
        "and returns a graph of the data")
    parser.add_argument(
        "-f",
        "--file-name",
        dest="file_name",
...
class MM_Kinetic_Solver:
    """The equations and functions used to calculate the kinetic parameters for the Michaelis-Menten Model

    ...
    Usage
    -----
    MM_Kinetic_Solver( v max value, km value)
    ...
    def mm_equation(self, num, substrate):
        """MM equation for a singular substrate index
        ...
        
        Attributes
        ----------
        num : int
            index of substrate values to compute the MM equation velocity for
        substrate : list
    ...
    def square_sum(self, cal, dat):
        ...
        cal : int
            velocity value for a specific substrate calculated using the MM equation
        """
    ...
    def full_equation(self, substrate, vvalues):
        """Generates a symbolic representation of the full residual sum of squares equation using the MM equation
        ...
        global minimum to give vmax and km.
        ...
        Attributes
        ----------
        substrate : list
    ...
    def minimize(self, df_dvmax, df_dkm):
        ...
        to zero and finds a set of (vmax, km) that satisfies each partial equal to zero.
        This ensures that the solution found in the mimimum of the sum of squares equation, 
        determining the parameters that best fit the data. The initial Vmax and Km guesses 
        are used as starting guesses to speed up the calculation and ensure 
        convergance.
        ...
        Attributes
        ----------
...
class graph_kinetic_data:
    ...
    kinetic_parameters : list
        list of the best-fit kinetic_parameters: [vmax, km]
    vv_std : list or int

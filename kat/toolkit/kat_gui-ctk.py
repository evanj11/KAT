...
kat = Image.open("kat/.imgs/ChatGPT Image Apr 18, 2025, 12_39_18 PM.png")
...
kat1 = Image.open("kat/.imgs/ChatGPT Image Apr 18, 2025, 12_39_18 PM.png")
...
run_button1.grid(row=1, column=1, columnspan=1, pady=15, padx=15)

run_button1a = ctk.CTkButton(tabview.tab("Hill Kinetics"), text="Graph Best Fit Hill", command=graph_hill_best_fit)
run_button1a.grid(row=2, columnspan=1, column=1, pady=15, padx=15)

h = Image.open("kat/.imgs/hill.png")
photo_h = ctk.CTkImage(light_image=h, size=(155,55))
heq = ctk.CTkLabel(tabview.tab("Hill Kinetics"), image=photo_h, text="")
heq.grid(row=1, column=2, rowspan=4, columnspan=2, pady=15, padx=15)
...
run_button3.grid(row=1, column=1, columnspan=1, pady=15, padx=15)

run_button3a = ctk.CTkButton(tabview.tab("Inhibition Kinetics"), text="Uncompetitve?", command=graph_uncompetitive)
run_button3a.grid(row=2, column=1, columnspan=1, pady=15, padx=15)

run_button3b = ctk.CTkButton(tabview.tab("Inhibition Kinetics"), text="Non-Competitive?", command=graph_noncompetitive)
run_button3b.grid(row=3, column=1, columnspan=1, pady=15, padx=15)

inh = Image.open("kat/.imgs/inhibitor.png")
photo_inh = ctk.CTkImage(light_image=inh, size=(155,55))
inheq = ctk.CTkLabel(tabview.tab("Inhibition Kinetics"), image=photo_inh, text="")
inheq.grid(row=1, column=2, rowspan=4, columnspan=2, pady=15, padx=15)
